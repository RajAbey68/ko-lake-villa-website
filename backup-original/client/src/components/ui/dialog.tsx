...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1 text-center sm:text-left mb-2",
      className
    )}
    {...props}
  />
